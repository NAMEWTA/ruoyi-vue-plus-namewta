...
public class EnterpriseVerificationCallbackController {
    ...
    public EnterpriseVerificationCallbackController(EnterpriseVerificationAttemptCoordinator coordinator,
