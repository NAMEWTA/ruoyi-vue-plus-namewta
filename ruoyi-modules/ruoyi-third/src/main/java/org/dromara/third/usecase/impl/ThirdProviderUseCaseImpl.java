...
public class ThirdProviderUseCaseImpl implements ThirdProviderUseCase {
    ...
    public void save(ThirdProviderBo bo) { service.save(bo); }
    public void changeStatus(Long providerId, String status) { service.changeStatus(providerId, status); }
    public void remove(Long providerId) { service.remove(providerId); }
}
